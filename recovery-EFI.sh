...
# "\033[31m" e "\033[m" são responsáveis por colorir a letra em vermelho, "\n" é responsável por pular uma linha
    ...
    echo -e '\033[36m Exemplo de utilização do script: ./recovery.sh /dev/sda HD500.gpt\n\033[m';
...
atualiza_recovery() {
    ...
    echo -e '\033[36m Formatando a partição RECOVERY...\n\033[m'
    
    # Formata a partição recovery, trocando a UUID

    mkfs.${SA_PARTRECOVERY} -Fq -O ^metadata_csum -U ${PARTRECOVERY,,} -L "RECOVERY" $RECOVERY

    echo -e '\033[36m A formatação da partição RECOVERY foi concluída com sucesso.\n\033[m'

    #Restaura a partição recovery a partir do arquivo recovey.tar.bz2 presente no pendrive na segunda partição (ex:sdb2)

    mount $RECOVERY /mnt

    echo -e '\033[36m Restaurando a partição RECOVERY...\n\033[m'

    tar -jxf recovery.tar.bz2 -C /mnt

    echo -e '\033[36m A restauração da partição RECOVERY foi concluída com sucesso.\n\033[m'

    echo -e '\033[36m Instalando e atualizando o GRUB...\n\033[m'
    ...
    echo -e '\033[36m O GRUB foi instalado e atualizado com sucesso...\n\033[m'
...
formatar_dados() {
    ...
    echo -e '\033[36m Formatando a partição DADOS...\n\033[m'
    ...
    echo -e '\033[36m A Formatação da partição DADOS foi concluída com sucesso.\n\033[m'
...
formatar_efi() {
    ...
    echo -e '\033[36m Formatando a partição EFI...\n\033[m'
    
    # Formata a partição EFI, atribuindo a UUID e rótulo
    
    mkfs.${SA_PARTEFI} -F 32 -i `echo ${PARTEFI^^} | tr -d -` -n "EFI" $EFI
    
    echo -e '\033[36m A Formatação da partição EFI concluída com sucesso.\n\033[m'
...
formatar_linux() {
    ...
    echo -e '\033[36m Formatando a partição LINUX...\n\033[m'
    ...
    echo -e '\033[36m A Formatação da partição LINUX foi concluída com sucesso.\n\033[m'
...
formatar_swap() {
    ...
    echo -e '\033[36m Formatando a partição SWAP...\n\033[m'
    
    #Formata a partição swap, trocando a UUID e rótulo
    
    mk${SA_PARTSWAP} -U ${PARTSWAP,,} -L "SWAP" $SWAP    

    echo -e '\033[36m A Formatação da partição SWAP foi concluída com sucesso.\n\033[m'
...
formatar_windows() {
    ...
    echo -e '\033[36m Formatando a partição WINDOWS...\n\033[m'
    ...
    echo -e '\033[36m A Formatação da partição WINDOWS foi concluída com sucesso.\n\033[m'
...
instalar_recovery(){
    ...
    echo -e '\033[36m Instalando o RISO RECOVERY UEFI...\n\033[m'
    ...
    echo -e '\033[36m Formatando as partições...\n\033[m'
    ...
    echo -e '\033[36m A formatação das partições foi concluída com sucesso.\n\033[m'
    ...
    echo -e '\033[36m A Partição RECOVERY foi restaurada com sucesso.\n\033[m'

    echo -e '\033[36m A instalação do RISO RECOVERY UEFI foi concluída com sucesso.\n\033[m'
...
instalar_UUID() {
    ...
    echo -e '\033[36m Atribuindo a UUID padrão nas partições...\n\033[m'
    ...
    echo -e '\033[36m A atribuição da UUID padrão nas partições foi concluída com sucesso.\n\033[m'

    echo -e '\033[36m Montando as partições recovery, /dev, /proc, /sys e /efi  no diretorio /mnt...\n\033[m'
    ...
    echo -e '\033[36m As Partições foram montadas com sucesso.\n\033[m'
    ...
    echo -e '\033[36m Desmontando as partições montadas no diretório /mnt...\n\033[m'
    ...
    echo -e '\033[36m As Partições foram desmontadas com sucesso.\n\033[m'
